...
public class StatusLayoutManager {
    ...
    private void addAllLayoutToRootLayout() {
        ...
        if (this.emptyDataVs != null)
            rootFrameLayout.addViewStub(emptyDataVs, RootFrameLayout.LAYOUT_EMPTYDATA_ID);
        if (this.errorVs != null)
            rootFrameLayout.addViewStub(errorVs, RootFrameLayout.LAYOUT_ERROR_ID);
        if (this.netWorkErrorVs != null)
            rootFrameLayout.addViewStub(netWorkErrorVs, RootFrameLayout.LAYOUT_NETWORK_ERROR_ID);
    }
    ...
    public static final class Builder {
        ...
        public RootFrameLayout rootFrameLayout;

        public Builder(Context context) {
            this.context = context;
        }

        public Builder setRootView(RootFrameLayout rootView) {
            this.rootFrameLayout = rootView;
            return this;
        }
